...
<img src="" width="100%" alt="Portada" id="postImage" /> <!-- Se carga en vivo la portada, según el input -->
...
<form action="<?php echo base_url(); ?>PostCreator/create" method="post" id="postUploader">
    ...
    <script>
        // Para cargar la portada dinámicamente
        document.getElementById("image").addEventListener("input", postImageLive);
        function postImageLive() {
            var image = document.getElementById("image").value;
            document.getElementById("postImage").src= image;
            console.log("postImageLive() en acción");
        }
