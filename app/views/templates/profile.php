...
<div id="root"><div id="profile">
        ...
        <?php   $i = 0;
                $posts = false; // True sólo sí creó algún post
                ...
                $i = 0;
                while( isset($video[$i]) ) {
                        echo '<li><a href="'.base_url().'Post/index/video/'.$video[$i]['subForum'].'/'.$video[$i]['slug'].'">'.$video[$i]['title'].'</a></li>';
                        $i++;
                        $posts = true;
                }
                $i = 0;
                ...
                $i = 0;
                if(!$posts) {
                        echo '<p>No escribiste ningún post, ¡<a href="'.base_url().'createPost">animate</a>!</p>';
                }
        ?>
